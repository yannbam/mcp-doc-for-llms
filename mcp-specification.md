...
- [Base Protocol](#base-protocol)
  ...
  - [Basic Protocol Utilities](#basic-protocol-utilities)
...
- The server **SHOULD NOT** send requests other than pings and
  logging before receiving the `initialized` notification.
...
Resources **MAY** be embedded, to provide additional context or data, behind a URI that can be subscribed to
...
Versioning for more information about how the protocol is versioned.
